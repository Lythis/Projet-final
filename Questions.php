<?php
    ...
    // Si nos POST ne sont pas vide (qu'une question a donc été posée)
    ...
    // Si nos POST ne sont pas vide (qu'une categorie a donc été posée)
    elseif (!empty($_POST['ajoutCategorie']) && !empty($_POST['newCategorie']) && $_POST['ajoutCategorie'] == 'valide') {
    ...
    ?>
        <div class="card">
            <div class="card-body">
                <p class="card-text" style="margin-left: 28%;"><img src="image/check.gif" style="width: 48%; margin-right: 6%;" class="" alt="pouve en l\'air"><p style="margin-left: 22%;">Votre catégorie a bien été enregistrée. <a href="./Questions.php">Poser une question</a>.</p></p>
            </div>
        </div>
    <?php
    }
