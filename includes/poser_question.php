                    ...
                    <form method="post" action="Questions.php" novalidate>
                        <div class="form-group">
                            ...
                            <div class="col-lg needs-validation">
                                ...
                                <p>Tu n'as pas trouvé une catégorie qui te correspond? <br>Alors clique <a data-toggle="modal" data-target="#newCateg" class="text-primary"> ici</a> pour rajouter une catégorie.</p>
                                <p>Tu préfères retirer une catégorie qui ne te plaît pas? <br>Clique <a data-toggle="modal" data-target="#suppCateg" class="text-danger"> ici</a> pour supprimer une catégorie.</p></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered " role="document">
                                    ...
                                    <div class="modal-footer">
                                        <button id="supp" type="submit" class="btn btn-danger mt-3"  name="supprimer" value="valide">Supprimer</button>
                                        </form>
                                    </div>
                                    </div>
                                </div>
